...
import { TheoryBlock, TheoryCard } from './components/components';
    ...
    <Page heading="Blind print">
      <TheoryBlock title="A little bit of history">
        ...
        <p>
              ...
              without looking at the keys of a typewriter or keyboard, using all
              (or most) of the fingers. Formerly known as 
          <strong> the American ten-finger blind method</strong>. It has been
              in existence for over <strong>120 years</strong>.
        </p>
        <p>
              Blind typing was
          <strong> developed by Frank Edgar McGurrin</strong>, a Salt Lake
              City court stenographer. On July 25, 1888, McGurrin, the only
              known person to use this method at the time, won the first
              printing competition held in Cincinnati. The results of the
              competition appeared on the front pages of many newspapers.
        </p>
      </TheoryBlock>
      <hr />
      <TheoryBlock title="Why blind print?">
        <p>
              ...
              about high speed. 
          <strong>Typing quickly means saving time</strong>, which is
              sometimes so lacking.
        </p>
        <div className={getAllowedClasses('d-flex me-2 justify-content-between', styles.reasons)}>
          <TheoryCard image={eyesImage}>
            <p>
              <strong>Firstly</strong>, these are our eyes. If you type a
                  text, and during all the time you looking from the monitor to the buttons and
                  back, then the eyes very quickly begin to get tired.
            </p>
            <p>
                  Using the ten-finger typing method, you do not need to look at
                  the keyboard at all, so you will be less tired, and your neck
                  and eyes will not hurt.
            </p>
          </TheoryCard>
          <TheoryCard image={quickTypeImage}>
            <p>
              <strong>Secondly</strong>, when you are typing blindly, text input
                  ...
                  unmistakably pressed by the finger it should be
                  pressed.
            </p>
            <p>
                  As a result, your attention is focused not on typing, but only
                  on how express your thoughts in the most beautiful and meaningful possible way.
            </p>
          </TheoryCard>
        </div>
      </TheoryBlock>
        ...
        <div className={getAllowedClasses('d-flex', styles.tenFingerMethod)} >
          <div className={styles.tenFingerText}>
            ...
            <p>
              ...
              text without using a mouse. 
              Which is even faster with some
              practice.
            </p>
          </div>
