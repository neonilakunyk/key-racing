...
import { AppRoute, FieldType } from 'common/enums/enums';
...
import { signUpSchema } from 'common/validations/validations';
import { IRegister } from 'common/interfaces/interfaces';
