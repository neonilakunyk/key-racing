...
import { FormField, FormPasswordField, Link, Sign } from '../../common/common';
import { loginSchema } from '../../../common/validations/validations';
import {
  useAppDispatch,
  useHistory,
  useForm,
...
import { ILogin } from 'common/interfaces/interfaces';
