...
import { FieldType, ToastMessage } from '../../../../common/enums/enums';
import { useForm, yupResolver } from 'hooks/hooks';
import { profileInfoSchema } from '../../../../common/validations/validations';
import {
  MAX_FILE_SIZE,
  ALLOWED_FILE_TYPES,
...
import { CropAvatar, ApplyChangesButton } from '../components';
      ...
      <Row className="m-0">
        ...
        >
          ...
          {user?.avatar && (
            <Button
              variant="danger"
              className={getAllowedClasses(styles.avatarControlButton, 'mb-3')}
